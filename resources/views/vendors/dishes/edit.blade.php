            ...
            <div class="col-xl-12">
                ...
                <form method="POST" action="{{ route('vendors.dishes.update', ['id' => $dish['id']]) }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="restaurant_id" id="restaurant_id">
                            ...
                            @foreach($restaurants as $restaurant)
                                <option value="{{ $restaurant->id }}" {{ $restaurant->id == $dish->restaurant_id ? 'selected' : '' }}>{{ $restaurant->name }}</option>
                            @endforeach
                        </select>
                        @error('restaurant_id')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="subcategory_id" id="subcategory_id">
                            ...
                            @foreach($subcategories as $subcategory)
                                <option value="{{ $subcategory->id }}" {{ $subcategory->id == $dish->subcategory_id ? 'selected' : '' }}>{{ $subcategory->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Dish's Name" id="text" value="{{ $dish->name }}">
                        @error('name')
                        <span class="text-danger ml-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="description" id="description" placeholder="Dish's Description" value="{{ $dish->description }}">
                        @error('description')
                        <span class="text-danger ml-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="is_veg" id="is_veg">
                            ...
                            <option value="1" {{ $dish->is_veg == 1 ? 'selected' : '' }}>Veg</option>
                            <option value="0" {{ $dish->is_veg == 0 ? 'selected' : '' }}>Non-Veg</option>
                        </select>
                        @error('is_veg')
                        <span class="text-danger ml-2" role="alert">
                            <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="price" placeholder="Dish's Price" id="price" value="{{ $dish->price }}" onchange="calculateDiscountedPrice()">
                        @error('price')
                        <span class="text-danger ml-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="discount_percentage" placeholder="Dish's Discount %" id="discount_percentage" value="{{ $dish->discount_percentage }}" onchange="calculateDiscountedPrice()">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="discount_price" placeholder="Dish's Discounted Price (in &#8360;)" id="discount_price" value="{{ $dish->discount_price }}" readonly>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="is_active" id="is_active">
                            ...
                            <option value="1" {{ $dish->is_active == 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ $dish->is_active == 0 ? 'selected' : '' }}>Inactive</option>
                        </select>
                    </div>
                    <div class="form-group mb-3">
